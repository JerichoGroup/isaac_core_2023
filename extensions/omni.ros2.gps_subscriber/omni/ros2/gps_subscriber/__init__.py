...
class OmniRos2GpsSubscriberExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[omni.ros2.gps_subscriber] OmniRos2GpsSubscriberExtension startup", flush=True)

    def on_shutdown(self):
        print("[omni.ros2.gps_subscriber] OmniRos2GpsSubscriberExtension shutdown", flush=True)
