...
class OmniRos2RangePublisherExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[omni.ros2.range_publisher] OmniRos2RangePublisherExtension startup", flush=True)

    def on_shutdown(self):
        print("[omni.ros2.range_publisher] OmniRos2RangePublisherExtension shutdown", flush=True)
